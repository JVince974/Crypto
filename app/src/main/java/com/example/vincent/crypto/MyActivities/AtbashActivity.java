...
import com.example.vincent.crypto.ChiffrementClass.AtbashChiffrement;
import com.example.vincent.crypto.R;

public class AtbashActivity extends AppCompatActivity {
    private static final String TAG = "AtbashActivity";
    ...
    public void crypt(View view) {
        if (noError()) {
            String messageFinal = AtbashChiffrement.crypt(message);
    ...
    public void decrypt(View view) {
        if (noError()) {
            ...
            try {
                messageFinal = AtbashChiffrement.decrypt(message);
            } catch (Exception e) {
