...
import com.example.vincent.crypto.ChiffrementClass.PlayFairChiffrement;
import com.example.vincent.crypto.R;

public class PlayFairActivity extends AppCompatActivity {
    private static final String TAG = "PlayFairActivity";
    ...
    public void crypt(View view) {
        if (noError()) {
            String messageFinal = PlayFairChiffrement.c(key, message);
    ...
    public void decrypt(View view) {
        if (noError()) {
            String messageFinal = PlayFairChiffrement.d(key, message);
            tvResponse.setText(messageFinal);
            Log.d(TAG, "messageFinal : " + messageFinal);
        }
    }
