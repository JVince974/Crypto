...
import com.example.vincent.crypto.ChiffrementClass.RectangulaireChiffrement;
import com.example.vincent.crypto.R;

public class RectangulaireActivity extends AppCompatActivity {
    private static final String TAG = "RectangulaireActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rectangulaire);
    ...
    public void crypt(View view) {
        if (noError()) {
            String messageFinal = RectangulaireChiffrement.crypt(key, message);
    ...
    public void decrypt(View view) {
        if (noError()) {
            String messageFinal = RectangulaireChiffrement.decrypt(key, message);
            tvResponse.setText(messageFinal);
            Log.d(TAG, "messageFinal : " + messageFinal);
        }
    }
